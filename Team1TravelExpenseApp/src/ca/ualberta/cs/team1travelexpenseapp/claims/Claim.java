...
/**
 * * Claim is the base class for containing a user's claim information. Claim
 * object encapsulates various types of the user's claim information needed for
 * the various services that the app supports. This information includes:
 * <ul>
 * <li>The Expense List
 * <li>Claimant Name
 * <li>Start date
